...
/*!40000 ALTER TABLE `annonceur`
    DISABLE KEYS */;

INSERT INTO `annonceur` (`id_annonceur`, `email`, `nom_annonceur`, `telephone`)
VALUES (1, 'annonceur1@exemple.ptdr', 'Bernard', '0607080910'),
...
/*!40000 ALTER TABLE `annonce`
    DISABLE KEYS */;

INSERT INTO `annonce` (`id_annonce`, `id_categorie`, `id_sous_categorie`, `id_annonceur`, `id_departement`, `prix`,
                       `date`, `titre`, `description`, `ville`, `mdp`)
VALUES (1, 1, 1, 1, 1, 35, '2014-12-15', 'Titre de l\'annonce 1',
        ...
        'Bar-le-Duc', 'azerty'),
       (2, 2, 2, 2, 3, 99, '2014-12-16', 'Titre de l\'annonce 2',
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab alias asperiores, corporis distinctio dolorem\ndolores facere iure, laboriosam minima nostrum odit praesentium, quaerat quia reprehenderit soluta totam\nvoluptatem. Corporis, nemo.',
        'Metz', 'didierchantal'),
...
/*!40000 ALTER TABLE `sous_categorie`
    DISABLE KEYS */;
